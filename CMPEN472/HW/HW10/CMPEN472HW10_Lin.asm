...
GW2         LDAA        1,Y+          ; Check the forth char
            CMPA        #CR           ; Check if the forth is a return
            BNE         Error0        ; If not, wrong input then
...
GQ2         LDAA        1,Y+          ; Check the forth char
            CMPA        #CR           ; Check if the forth is a return
            BNE         Error0        ; If not, wrong input then
...
oc3isr      LDD          #3000        ; 125usec with (24MHz/1 clock)
            ...
            CMPA         #$03
            BEQ          square       ; Branch to square
            CMPA         #$04
            BEQ          sawtooth2    ; Branch to sawtooth 100Hz
            CMPA         #$05
...
setflag1    LDAA         #$00         ; load A with 0
            ...
            ;DECB                      ; Decreas B
            ;STAB         trig_counter ; update counter
            LBRA          oc3done      ; Branch to oc3done
...
;  Message Here
prompt      DC.B        '> ', $00
main_msg0   DC.B        'Welcome to HW10 program, this program will provede digital clock features and can plot different waveforms', $00
main_msg1   DC.B        "1. For Digital Clock Program, We have 5 commands can use, they are:'t' for 'set time' command, 'q' for 'quit' command,", $00
...
main_msg6   DC.B        '5. For Waveform Generation Program, we provide 5 commands to draw different type of waveform with different frequency.', $00
main_msg7   DC.B        '6. Command gw : generate sawtooth wave, printing 0 through 255, repeated for total 2048 points.', $00
main_msg8   DC.B        '7. Conmand gw2:  generate sawtooth wave of 100Hz, wave repeated for total 2048 points.', $00
main_msg9   DC.B        '8. Command gt : generate triangle wave, printing 0 through 255, then 255 down to 0, repeated for total 2048 points.', $00
main_msg10  DC.B        '9. Command gq : generate square wave, printing 0 for 255 times, then print 255 for 255 times, then repeated for total 2048 points.',$00
main_msg11  DC.B        '10.Command gq2 : generate square wave of 100Hz, wave repeated for total 2048 points.',$00
...
gw_msg      DC.B        'Open RxData3.txt and hit enter key to start generating sawtooth wave ....', $00
gw2_msg     DC.B        'Open RxData3.txt and hit enter key to start generating sawtooth wave 100Hz', $00
gt_msg      DC.B        'Open RxData3.txt and hit enter key to start generating triangle wave ....', $00
gq_msg      DC.B        'Open RxData3.txt and hit enter key to start generating square wave ....', $00
gq2_msg     DC.B        'Open RxData3.txt and hit enter key to start generating square wave 100Hz ....', $00
done_msg    DC.B        'Done. Waveform has been generated and saved to RxData3.txt. Make sure you close the RxData3.txt', $00
end_msg     DC.B        '       Wave Generator and Clock stopped and Typewrite program started.', $00
