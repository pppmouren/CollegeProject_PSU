...
*    3. hit any other key to quit
*    4. key hit must followed by an <Enter> key
* 
...
* 
* Homework 1 Sample Program 3 turns on/off Red and Green LEDs by keyboard.
*   Program stops by hitting any key other than 'r' and 'g' keys.
*   >>>>> key hit must followed by an <Enter> key <<<<<
* 
***************************************************/
...
int main( void )
{
  ...
  if (io != NULL)
  {
    ...
    printf("\n Key hit is not 'r' or 'g' key, quiting loop\n");
