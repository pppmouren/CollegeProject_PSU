/**************************************************
* File:  hw0c3pth2func.c 
* Homework 4, pthread Sample 2 Program 
* By Kyusun Choi
...
* 
* This is a Homework 4, pthread Sample 2 Program, simple LED blinking. 
...
*  This is the 2nd sample program, simply showing two LED blinking.
*    Note the basic GPIO parameter use.
*  This program:
*    Blink  Red    LED 1 at GPIO 12, blink at 5Hz rate, for 15 times
*    Blink  Green  LED 2 at GPIO 13, blink at 5Hz rate, for 15 times
...
void RedBlink(int count, struct io_peripherals *io)
{
  int i = 0;
...
void GreenBlink(int count, struct io_peripherals *io)
{
  int i = 0;
...
int main( void )
{
  ...
  if (io != NULL)
  {
    ...
    printf("\n Blink Red LED 15X, then blink Green LED 15X\n");
