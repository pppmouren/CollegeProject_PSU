/**************************************************
* File:  hw0c3pth3parm.c 
* Homework 4, pthread Sample 3 Program 
* By Kyusun Choi
...
* 
* This is a Homework 4, pthread Sample 3 Program, simple LED blinking. 
...
*  This is the 3rd sample program, simply showing two LED blinking.
