/**************************************************
* File:  hw7Lin.c 
* Homework 7, manual car driving, self black line tracing, and IMU data collecting and analyzing
* By Xuhong Lin
* CMPEN 473, Spring 2024, Penn State University
* 
* This is a Homework 7, we will use command to control car driving
* Three Modes: 'm0' for 5s data collecting by MPU6250 IU chip, 'm1' mode for manual driving, 'm2' mode for self black line tracing
...
* 
* QUICK NOTE:
* 1. always display on a terminal window the prompt ‘Hw7>' and display
...
* 		3.4. Collecting 3-axis accelerometer and 3-axis gyroscope data suring driving.
* 4. m0 mode:
...
int main( void )
{
  ...
  FILE *fd_m0 = fopen("hw7m0data.txt", "w");
  FILE *fd_m1 = fopen("hw7m1data.txt", "w");
  FILE *fd_m2 = fopen("hw7m2data.txt", "w");
